...
public class UsuarioResource {
	...
	public ResponseEntity<Mensagem> alterarSenha(
			@PathVariable Long codigo, 
			@RequestParam(name="senha_atual") String senhaAtual,
			@RequestParam(name="nova_senha") String novaSenha,
			@RequestParam(name="nova_senha_conf") String novaSenhaConf){
		
		
		return usuarioService.verificaSenhas(codigo, senhaAtual, novaSenha, novaSenhaConf);
